...
@HiltViewModel
class HomeViewModel @Inject constructor(private val rickMortyRepository: RickMortyRepository
): ViewModel() {
    ...
    init {
        viewModelScope.launch { _state.value=rickMortyRepository.getCharacters().results }
    }
}